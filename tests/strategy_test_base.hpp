...
protected:
  ...
  dsp::strategies::AntennaProcessorConfig cfg_;
...
private:
  ...
  void BuildConfig() {
    ...
    cfg_.scenario_mode       = dsp::strategies::PostFftScenarioMode::ALL_REQUIRED;
  ...
  void PrepareMatrix() {
    ...
    d_W_        = dsp::strategies::WeightGenerator::upload_to_gpu(backend_, W_cpu);
